...
namespace BusinessLogic
{
    public class BillDetailsBL
    {
        ...
        public DataTable GetSearch_Bill(int id)
        {
            return bdDA.GetSearchBillCustom(id);
        }
        public DataTable GetSearch_Toy(string tenDC)
        {
            return bdDA.GetSearchToyCustom(tenDC);
        }
        public DataTable GetSearch_Customer(string tenKhachHang)
        {
            return bdDA.SearchCustomerDetail(tenKhachHang);
        }
